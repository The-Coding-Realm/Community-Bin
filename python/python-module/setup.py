...
with open("README.md", "r") as fh:
    long_description = fh.read()  # get readme and import it for long description of module
...
setup(
    ...
    long_description_content_type="text/markdown",  # long description file type 
