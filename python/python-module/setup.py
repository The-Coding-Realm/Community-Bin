...
setup(
    ...
    long_description=long_description,  # module long description, if you want to manually write it change the variable to string and type your long description
